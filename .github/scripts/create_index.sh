...
for odd_file in $ODDS_TO_PROCESS; do
	...
	echo "
## ${odd_basename}"
	if [ -f "documentation/${GITHUB_REPOSITORY}/${odd_basename}.html" -o -f "rng/${odd_basename}.rng" ]; then
		echo
		for resource in "documentation/${GITHUB_REPOSITORY}/${odd_basename}.html" "rng/${odd_basename}.rng"; do
